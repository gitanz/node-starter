    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "number10Decimals2": {
                    "regex": /^-?\d{0,10}(\.\d{0,2})?$/,
                    "alertText": "* FF Maximum 12 characters allowed, Format (0.99)"
                },
                "password": {
                    "regex": /^(?=.*\d)(?=.*[a-z])(?=.*(_|[^\w]))(?=.*[A-Z]).{9,20}$/,
                    "alertText": " FF Password should consist of <br/>" +
                    " ● FF atleast 9 characters<br/>" +
                    " ● FF atmax 20 characters<br/>" +
                    " ● FF atleast 1 Lowercase letter<br/>" +
                    " ● FF atleast 1 Uppercase letter<br/>" +
                    " ● FF atleast 1 Digit <br/>" +
                    " ● FF atleast 1 Symbol <br/>"
                },
                "date": {
                ...
                "countmax": {
                    ...
                    "alertText": " * FF The number of symbols must not exceed :max symbols. There are symbols :count now.",
                    "CustomAlertMessage": function () {
                        alert = " * FF The number of symbols must not exceed :max symbols. There are symbols :count now."
                        return alert;
                    }
                },
                "lessThanMax": {
