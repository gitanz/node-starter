jQuery(document).ready(function () {
    ...
    function responsive() {
        ...
        if (!jQuery('.showmenu').hasClass('clicked')) {
            ...
            else if(!jQuery('.leftpanel').hasClass('hide')) {
        ...
        if (windowWidth < 1024) {
            jQuery('.mainwrapper').css('width', "1007px");
        }

        else {

            jQuery('.mainwrapper').css('width', windowWidth);
        }
    ...
    if (jQuery('.showhide').length > 0) {
        jQuery('.showhide').click(function () {
            ...
            t.text((target.is(':visible')) ? 'Views Source' : 'Hide Source');
    ...
    jQuery('.skin-layout').click(function () {
        jQuery('.skin-layout').each(function () {
