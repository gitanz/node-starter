                                            ...
                                            if (options.contentAdditionalProperty[cap].name == $(this).find('a').attr('field-name')) {
                                                ...
                                                if (options.contentAdditionalProperty[cap].type != null && options.contentAdditionalProperty[cap].type == 'Text') {
                                                    ...
                                                    for (k = 0; k < options.contentAdditionalProperty[cap].properties.length; k++) {
                                                        ...
                                                        else if (options.contentAdditionalProperty[cap].properties[k].type != null && options.contentAdditionalProperty[cap].properties[k].type == "Custom2") {

                                                            if (options.contentAdditionalProperty[cap].properties[k].whenValue == item[options.contentAdditionalProperty[cap].referenceField]) {
                                                                additionalControl.find(options.contentAdditionalProperty[cap].properties[k].field).attr(options.contentAdditionalProperty[cap].properties[k].property,
                                                                    options.contentAdditionalProperty[cap].properties[k].value);
                                                                if(options.contentAdditionalProperty[cap].properties[k].property2 != null && options.contentAdditionalProperty[cap].properties[k].value2 != null){
                                                                    additionalControl.find(options.contentAdditionalProperty[cap].properties[k].field).attr(options.contentAdditionalProperty[cap].properties[k].property2,
                                                                        options.contentAdditionalProperty[cap].properties[k].value2);
                                                                }
                                                            }

                                                            additionalControl.find(options.contentAdditionalProperty[cap].properties[k].field).text(item[options.contentAdditionalProperty[cap].name]);
